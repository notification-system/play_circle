...
We currently have a separate kanban board with prioritized features, if you want to help please contact us.
...
* DO format your code using Google Java Format. An appropriate Git pre-commit hook is avaliable under scripts/hooks
